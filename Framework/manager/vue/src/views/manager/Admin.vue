...
export default {
  ...
  methods: {
    ...
    del(id) {
      this.$confirm('Are you sure you want to delete?', 'Confirm Deletion', {type: "warning"}).then(() => {
    ...
    delBatch() {
      ...
      this.$confirm('Are you sure you want to delete these items?', 'Confirm Deletion', {type: "warning"}).then(() => {
